...
\begin{document}
	...
	% Cambiando la palabra Índice a Contenido
	...
	% Agregando la linea que separa el indice del texto inicial
	\vspace{0.25cm}
	\hrule
	
	% Insertando el contenido del documento. Los archivos a insertar deben iniciar con \section{}
	\input{github}
